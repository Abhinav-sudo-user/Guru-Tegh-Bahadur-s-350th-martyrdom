    ...
    <>
      ...
      <div className="history-page">
        ...
        <div className="history-overview">
          ...
          <p className="mb-2">
            Guru Tegh Bahadur Ji [Wednesday, April 18, 1621 – Wednesday,
            November 24, 1675], revered as Srisht-di-Chadar (Protector of
            humanity), was the ninth Guru of the Sikhs. He became Guru on 16
            April 1664, succeeding his grand-nephew and the eighth Guru, Guru
            Har Krishan Ji.
          </p>
          <p className="mb-2">
            ...
            attachments, dignity, service, and deliverance, which are included
            in the sacred Sri Guru Granth Sahib Ji.
          </p>
          <p className="mb-2">
            Guru Ji traveled throughout the Indian subcontinent to spread Sikh
            teachings and established new preaching centers. He founded
            Chak-Nanki in Punjab, which was later developed into the city of Sri
            Anandpur Sahib by Guru Gobind Singh Ji.
          </p>
          <p className="mb-2">
            In May 1675, Hindu Pandits from Kashmir sought Guru Ji’s help
            against forced conversions to Islam under the Mughal rulers. Guru
            Tegh Bahadur Ji defended religious freedom, refused to convert to
            Islam himself, and was publicly executed by beheading in Delhi on
            Emperor Aurangzeb’s orders.
          </p>
          <p>
